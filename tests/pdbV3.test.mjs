...
assert.match(prompt.userPrompt, /FIELD DEPTH BUDGETS/);
assert.match(prompt.userPrompt, /Bottom line: 100-140 words/);
assert.match(prompt.userPrompt, /Each asset driver: 30-50 words/);
assert.match(prompt.userPrompt, /Each macro transmission channel: 30-50 words/);
assert.match(prompt.userPrompt, /Each scenario: 45-70 words/);
